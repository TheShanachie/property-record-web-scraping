...
class Config:
    ...
    @classmethod
    def _load_selenium_chrome_config(cls, config_path='./server/web_scraping_utils/config_utils/config/selenium_chrome.yaml'):
        """
    ...
    @classmethod
    def _load_logging_config(cls, config_path='./server/web_scraping_utils/config_utils/config/logging.yaml'):
        """
    ...
    @classmethod
    def _load_dump_database_config(cls, config_path='./server/web_scraping_utils/config_utils/config/dump_database.yaml'):
        """
