...
from logging_utils import WebScrapeLogger, RecordLogger
import json, traceback, datetime
from jsonschema import validate, ValidationError
from parsing import JSONCleaner
...
addresses = ["Main St"] # ["Main St", "Wood St", "State St"] # Addresses for the queries.
arguments = [{'address':address, 'pages':pages, 'num_results':10} for address in addresses] # Arguments for the queries.
